...
class Platform(TemplatedPlatform):
    ...
    def toolchain_prepare(self, fragment, name, *, emit_src=True, **kwargs):
        ...
        templates[hdl_name(converter.default_extension)] = templates[hdl_debug_name(converter.default_extension)] = r"""
        ...
        for key, value in templates.items():
            templates[key] = value \
                                .replace(hdl_name('v'), hdl_name(converter.default_extension)) \
                                .replace(hdl_debug_name('v'), hdl_debug_name(converter.default_extension))
        #####################################################################################################
